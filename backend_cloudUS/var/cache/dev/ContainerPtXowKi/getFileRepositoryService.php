 ...
 */
class getFileRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FileRepository.php';

        return $container->privates['App\\Repository\\FileRepository'] = new \App\Repository\FileRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
